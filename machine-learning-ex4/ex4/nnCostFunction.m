...
for i = 1:m,
	...
	big_delta1 = big_delta1 .+ delta2(2:end,:)*(a1(i,:));
	big_delta2 = big_delta2 .+ delta3*(a2(i,:));
%	temp(y(i,1),1) = 0;
end


Theta1_grad = big_delta1./m + (lambda/m)*[zeros(size(Theta1,1),1) Theta1(:,2:end)];
Theta2_grad = big_delta2./m + (lambda/m)*[zeros(size(Theta2,1),1) Theta2(:,2:end)];
